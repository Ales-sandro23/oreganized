...
public class ThermometerItem extends Item {
    protected static final Map<Block, Integer> HEATVALUE = (
            new ImmutableMap.Builder<Block, Integer>().put(Blocks.LAVA, 8)
                    .put(Blocks.LAVA_CAULDRON, 8).put(Blocks.FIRE, 4)
                    .put(Blocks.MAGMA_BLOCK, 3).put(Blocks.TORCH, 2)
                    .put(Blocks.LANTERN, 2).put(Blocks.CAMPFIRE, 3)
                    .put(Blocks.SOUL_CAMPFIRE, 3).put(Blocks.SOUL_FIRE, 3)
                    .put(Blocks.SOUL_LANTERN, 2)
    ).build();
